...
const ChooseItems = ({ selectedItems, handleSelectItem }) => {
  ...
  return (
    <section className="flex flex-col gap-5 rounded-lg bg-zinc-900 p-5 max-h-[700px]">
      <header className=" z-10 bg-zinc-900 pb-2">
